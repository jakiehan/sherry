module.exports = {
    ...
    "rules": {
        ...
        "sherry-plugin/sherry-layers-imports-fsd": ["error", { alias: '@', ignoreImportPatterns: [
          '**/StoreProvider', '**/StoreDecorator', '**/router', '**/testing', '**/stateSchema', '**/i18nForTests', '**/EditableProfileCard', '**/Article'
            ]
        }],
    },
    "settings": {
