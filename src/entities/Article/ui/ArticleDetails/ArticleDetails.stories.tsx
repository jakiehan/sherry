...
export const Primary: Story = {
  ...
  decorators: [
    (Story) => (
      <StoreDecorator state={{ articleDetails: { data } }}>
        <Story />
      </StoreDecorator>
    ),
  ],
...
export const Loading: Story = {
  ...
  decorators: [
    (Story) => (
      <StoreDecorator state={{ articleDetails: { isLoading: true } }}>
        <Story />
      </StoreDecorator>
    ),
  ],
...
export const Error: Story = {
  ...
  decorators: [
    (Story) => (
      <StoreDecorator
        // error -любая строка (проверка на наличие)
        state={{ articleDetails: { error: 'error' } }}
      >
        <Story />
      </StoreDecorator>
    ),
